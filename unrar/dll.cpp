...
int PASCAL RARReadHeaderEx(HANDLE hArcData,struct RARHeaderDataEx *D)
{
  ...
  try
  {
	...
	Data->Arc.FileHead.mtime.GetLocal((RarLocalTime *) &D->mtime);
	Data->Arc.FileHead.ctime.GetLocal((RarLocalTime *) &D->ctime);
	Data->Arc.FileHead.atime.GetLocal((RarLocalTime *) &D->atime);
	Data->Arc.FileHead.arctime.GetLocal((RarLocalTime *) &D->arctime);
